...
So what do you do? Check stack overflow. . .

And you will find you can instantiate a second firebase auth.

We heard you like apps so much we put an App within your App.
...
<br/>
<br/>
In your firebase config file just add a 2nd app that is using the same configuration. Pretty simple right. Can call it whatever. I have called it secondApp and it initializes a new firebase instance I am calling "Second".
<br/>
<br/>
